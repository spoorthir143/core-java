class SWatch1
{
	...
	static	String watchColor="Gold Link";
	...
	{
	   // String brandName="Noise";
		//int price=5698;
		//String watchColor="Gold Link";
		//String watchHeight="3.66 Millimeters";
		//String watchWidth="9 Centimeters";
		//String manufacturerAddress="Gurugram, haryana";
		//String screenDisplaySize="1.01 Inches";
		//String productDimension="5.9x9x0.37cm, 45g";
		//String batteries="1 Lithium Ion baatteries";
		//String itemModelNumber="wrb-sw-diva-mlt-gld_gld";
		//String connectivityType="Bluetooth";
		//String wirelessType="Bluetooth";
		//String wattage="40 Watts";
		//String operatingSystem="Android & Ios";
		//String batteryChargingTime="2 Hours";
		//String averageBatteryLife="4 Days";
		//String batteriesIncluded="yes";
		//int lithiumIonCells=1;
		//String components="Smartwatch, Magnetic charger, user manual, warranty card";
		//String productManufacturer="Nexxbase Marketing Pvt. Ltd";
		//String countryOfOrigin="India";
		//String itemweight="45g";
