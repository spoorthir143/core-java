class SmartPhone {
			...
			static		String simSlots="Dual Sim";
			static		String color="Green";
			static	int storageCapacity=128;
			static		double screenSize=6.7 ;
			static		int ram=4;
			static		String frontCameraResolution="Eight MP Front Camera";
...
public static void main(String[] args){
	...
	System.out.println("Storage Capacity is: "+storageCapacity);
	System.out.println("Screen Size is: "+screenSize);
	System.out.println("Ram is: "+ram);
	System.out.println("Front Camera Resolution is: "+frontCameraResolution);
